    ...
    <div class="container">
        ...
        <div id="table-section">
            ...
            <table id="program-table">
                ...
                <?php 
                    $query = "SELECT *, Interns.Name IntName FROM I_Projects INNER JOIN Interns
                              ON I_Projects.InternID  = Interns.InternID
                              INNER JOIN Department ON Interns.DeptID = Department.DeptID 
                              WHERE ProjectID = '$id' ORDER BY Interns.InternID";
